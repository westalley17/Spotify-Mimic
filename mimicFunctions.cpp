...
User* accessAccount(User*& currentUser, const std::string& username, Database& userAccountData)
{
    int accountChoice;
    do
    {
...
User* createAccount(Database& userAccountData, const std::string& old_username)
{
    std::string password;
